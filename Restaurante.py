...
aplicacion.title("PALI Restaurante - Sistema de Facturacion")

# color de fondo de la ventana
aplicacion.config(bg='dark grey')
...
etiqueta_titulo = Label(panel_superior, text='Sistema de Facturacion', fg='white',
                        font=('Dosis', 47), bg='dark grey', width=27)
...
# panel calculadora
panel_calculadora = Frame(panel_derecha, bd=1, relief=FLAT, bg='dark grey')
panel_calculadora.pack()

# panel recibo
panel_recibo = Frame(panel_derecha, bd=1, relief=FLAT, bg='dark grey')
panel_recibo.pack()

# panel botones
panel_botones = Frame(panel_derecha, bd=1, relief=FLAT, bg='dark grey')
panel_botones.pack()
